...
namespace Exams.Models
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(ExamsContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Check(Student a)
        {
            if (_context.Student.Any(x => x.UserName == a.UserName && x.Password == a.Password))
            {
